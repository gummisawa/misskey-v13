	...
	<FormSection>
		...
		<div class="_gaps_m">
			<div class="_gaps_s">
				...
				<MkSwitch v-model="showRenoteConfirmWindow">{{ i18n.ts.showRenoteConfirmWindow }}</MkSwitch>
			</div>
			<div>
...
const showRenoteConfirmWindow = computed(defaultStore.makeGetterSetter('showRenoteConfirmWindow'));
